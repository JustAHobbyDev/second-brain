...
```text
Running prompts/meta_program/00_context.txt with: python3 -c import sys; sys.stdin.read()
Running prompts/meta_program/10_generate_project_history_spec.txt with: python3 -c import sys; sys.stdin.read()
Running prompts/meta_program/20_phase_model_and_schema.txt with: python3 -c import sys; sys.stdin.read()
Running prompts/meta_program/30_closeout_template_integration.txt with: python3 -c import sys; sys.stdin.read()
Running prompts/meta_program/40_cognitive_profile_spec.txt with: python3 -c import sys; sys.stdin.read()
Running prompts/meta_program/50_agent_owned_audit.txt with: python3 -c import sys; sys.stdin.read()
Running prompts/meta_program/60_hyperfast_mode_route.txt with: python3 -c import sys; sys.stdin.read()

...
* [Agent Structural Legibility Benchmark Spec v0](STRUCTURAL_AUDIT_SPEC_v0.md)
* [Agent Structural Legibility Runbook v0](STRUCTURAL_AUDIT_RUNBOOK.md)
* [Ontology Architecture Map v0](meta/ONTOLOGY_ARCHITECTURE_MAP_v0.md)
